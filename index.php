            ...
            <?$count = count($array1);
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?=($array1[$i]['URL картинки']);?>" width="350" height="260" alt="Сноуборд">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?echo($array1[$i]['Категория']);?></span>
                        <h3 class="lot__title"><a class="text-link" href="lot.html"><?echo($array1[$i]['Название']);?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?echo($array1[$i]['Цена']);?><b class="rub">р</b></span>
                            </div>
